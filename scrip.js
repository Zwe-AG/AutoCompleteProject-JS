let autoCompleteInputTag = document.getElementsByClassName("autoCompleteInput")[0];
...
let filteredProducts = [];
    ...
    autoCompleteInputTag.addEventListener("keyup",(event)=>{
        ...
        let hasProductToShow = filteredProducts.length > 0 ;
        if(hasProductToShow){
    ...
    let navigateAndSelectProduct = (key) => {
        if(key === "ArrowDown"){
            ...
            let selectedProduct = selectProduct(indexToSelect);
    ...
    let deselectProduct = () =>{
        let productToDeselect =  document.getElementsByClassName("selected")[0];
    ...
    // <div class="productContainer" id="1">
